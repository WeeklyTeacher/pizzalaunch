...
Assert-True ($client.Contains('Follow the pizza arrows to the Pizza Cannon!')) 'first-spawn hint uses simple player language'
Assert-True ($client.Contains('Press E or tap the Pizza Cannon to start!')) 'launcher-reached hint supports keyboard and touch'
